...
if(mysqli_num_rows($result)>0){
    while($row=mysqli_fetch_assoc($result)){
        echo "<tr>
              ...
              <td>".$row["location"]."</td>";?>
            <td>
                <a href="index.php?edit" name="edit" class="button">Edit</a>
                <a href="index.php?delete" name="delete" class="button">Delete</a>
...
<input type="submit" class="button" name="create" value="Criar Registo">
</div>
</form>
</body>
</html>